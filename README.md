...
## 🛠️ Study
- ✅ Java의 정석 1, 2 (2023-10 ~ 2023-12)
- ✅ 스프링 입문 - 코드로 배우는 스프링 부트, 웹 MVC, DB 접근 기술 (2024-01)
- ✅ 실전! Querydsl (2024-01 ~ 2024-02)
- ✅ 스프링 입문을 위한 자바 객체 지향의 원리와 이해 (2024-02 ~ 2024-05)
- ✅ Wanted 컨테이너 기반 서버 관리 경험으로 면접 뽀개기 | 프리온보딩 BE 챌린지 5월 (2024-05)
- ✅ 스프링 핵심 원리 - 기본편 (2024-04 ~ 2024-06)
